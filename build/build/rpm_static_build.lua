...
function rpm_static_build()
    ...
    debian_static_build()
    darwin.dtw.copy_any_overwriting("release/debian_static_bin.out",
        ".cache/rpm_static_build/SOURCES/debian_static_bin.out"
    )
...
cp %{_sourcedir}/debian_static_bin.out   %{buildroot}/usr/local/bin/PROJECT_NAME
